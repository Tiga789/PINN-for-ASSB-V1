...
DEFAULT_OUTPUT_DIR = Path(r"C:\Users\Tiga_QJW\Desktop\ASSB_Scheme_V1\assb_soft_label_allcycle")
...
def save_continuous_solution(
    ...
    summary = {
        "source": "generate_assb_softlabel_allcycle.py",
        "uses_solver": "integration_spm/spm_int_assb_cycle.py",
        "version": "allcycle_continuous_fixedB_v1",
...
def main(argv: list[str] | None = None) -> int:
    ...
    print("[INFO] Continuous ASSB soft-label generation: allcycle fixed-B v1")
