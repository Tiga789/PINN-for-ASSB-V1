...
from thermo_assb_v0 import grad_ds_a_cs_a, grad_ds_c_cs_c
...
if args.lean:
    ...
    if args.explicit:
        ...
        # Default to the implicit solver if no explicit mode is requested.
        n_r = 64
        dt = 0.5
        config, sol = exec_impl(
            n_r, dt, params, deg_i0_a, deg_ds_c, verbose=True
