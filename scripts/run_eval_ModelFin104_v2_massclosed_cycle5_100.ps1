...
D:\Anaconda\envs\torchgpu\python.exe .\evaluate_assb_pinn_cycles5_100_v2_massclosed_softlabels.py `
  ...
  --cycle_from 5 `
  --cycle_to 100 `
  --output_dir EvalFin_104_cycles5_100_v2_massclosed_candidate_cRadial010_softlabel_only `
  --debug_print_first_batch

Write-Host ""
Write-Host "Worst per-cycle MAE summary:"
$csv = Import-Csv .\EvalFin_104_cycles5_100_v2_massclosed_candidate_cRadial010_softlabel_only\metrics_by_cycle.csv
