...
from gv1.d17_g.g14_trainer import build_and_train_g14
...
def main() -> int:
    ap = argparse.ArgumentParser(description="D17-G1.4 phie validation robustness repair")
    ...
    print(json.dumps({
        ...
        "validation_phie_mean_r2": summary.get("validation_report_only_per_target_aggregate", {}).get("phie_r2_mean"),
        "validation_phie_min_r2": summary.get("validation_report_only_per_target_aggregate", {}).get("phie_r2_min"),
        "worst_validation_phie_profile": summary.get("worst_validation_phie_profile"),
