...
$RunsRoot = Join-Path $CacheRoot "xjtu_batch134_d12_s1f_p2d_highsafe_fast_6x40ks"
$ProfilesRoot = Join-Path $CacheRoot "xjtu_batch134_replay_profiles"
$ScorecardDir = Join-Path $CacheRoot "xjtu_batch134_d12_s1f_p2d_highsafe_fast_6x40ks_scorecard"
...
$Preflight = [ordered]@{
  stage = "D12-S1F low-highsafe-fast 6-profile 40ks preflight"
...
$Preflight | ConvertTo-Json -Depth 6 | Tee-Object -FilePath (Join-Path $RunsRoot "D12_S1F_6profile_40ks_preflight.json")
...
Write-Host "D12-S1F 6x40ks done. Scorecard: $ScorecardDir"
