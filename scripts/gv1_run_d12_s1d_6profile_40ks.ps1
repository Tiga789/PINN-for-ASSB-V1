...
$RunsRoot = Join-Path $CacheRoot "xjtu_batch134_d12_s1d_p2d_regret_guarded_6x40ks"
$ProfilesRoot = Join-Path $CacheRoot "xjtu_batch134_replay_profiles"
$ScorecardDir = Join-Path $CacheRoot "xjtu_batch134_d12_s1d_p2d_regret_guarded_6x40ks_scorecard"
...
$Preflight = [ordered]@{
  stage = "D12-S1D regret-guarded 6-profile 40ks preflight"
...
$Preflight | ConvertTo-Json -Depth 6 | Tee-Object -FilePath (Join-Path $RunsRoot "D12_S1D_6profile_40ks_preflight.json")
...
Write-Host "D12-S1D 6x40ks done. Scorecard: $ScorecardDir"
