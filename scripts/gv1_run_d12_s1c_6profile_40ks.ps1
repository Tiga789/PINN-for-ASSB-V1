...
$RunsRoot = Join-Path $CacheRoot "xjtu_batch134_d12_s1c_p2d_balanced_6x40ks"
$ProfilesRoot = Join-Path $CacheRoot "xjtu_batch134_replay_profiles"
$ScorecardDir = Join-Path $CacheRoot "xjtu_batch134_d12_s1c_p2d_balanced_6x40ks_scorecard"
...
$Preflight = [ordered]@{
  stage = "D12-S1C balanced low-normal 6-profile 40ks preflight"
...
$Preflight | ConvertTo-Json -Depth 6 | Tee-Object -FilePath (Join-Path $RunsRoot "D12_S1C_6profile_40ks_preflight.json")
...
Write-Host "D12-S1C 6x40ks done. Scorecard: $ScorecardDir"
